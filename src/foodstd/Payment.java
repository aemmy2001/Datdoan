...
public class BillPrintable implements Printable {
  ...
  {    
     ...
     // int r= itemName.size();
      ImageIcon icon=new ImageIcon("F:\\project swing\\FoodSTD\\src\\img\\tsk.PNG"); 
      int result = NO_SUCH_PAGE;    
        ...
        try{
          ...
          String RecievedString="0 VNĐ";
            ...
            g2d.drawString("*************************************",10,y);y+=yShift;
            g2d.drawString("       SOFTWARE BY:TSK + STD          ",10,y);y+=yShift;
            g2d.drawString("   CONTACT: aemmysoutthida@gmail.com  ",10,y);y+=yShift;       
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Forte", 0, 13)); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font("Forte", 0, 13)); // NOI18N
        ...
        jLabel3.setFont(new java.awt.Font("Forte", 0, 13)); // NOI18N
